...
public class MainActivity extends ActionBarActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        /**
         * Casso o usu�rio deseje recarregar a lista
         */
    ...
    /**
     * M�todo respons�vel por garantir que a lista de cidades seja carregada apenas uma vez.
     */
    ...
    /**
     * Classe respons�vel por executar a busca do arquivo JSON na internet
     */
    public class CampusTask extends AsyncTask<Void, Void, String> {
        ...
        /**
         * m�todo respons�vel por transformar a string json em uma lista de cidades, que ser� alocada na vari�vel est�tica da clase Globals
         * @param jsonString
         */
